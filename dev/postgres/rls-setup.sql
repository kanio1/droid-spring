...
-- Applies to: All customer-specific tables
-- Created: 2025-11-07
-- ============================================
...
AND tablename IN ('customers', 'addresses', 'orders', 'order_items', 'invoices', 'invoice_items', 'payments', 'subscriptions', 'products');
