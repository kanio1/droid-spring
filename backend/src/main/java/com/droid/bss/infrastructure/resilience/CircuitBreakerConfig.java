...
public class CircuitBreakerConfig {
    ...
    public CircuitBreaker notificationServiceCircuitBreaker(CircuitBreakerRegistry registry) {
        CircuitBreakerConfig config = CircuitBreaker.custom()
                .slidingWindowSize(5) // Smaller window for notifications
                .minimumNumberOfCalls(3)
                .failureRateThreshold(70.0f) // More tolerant for notifications
