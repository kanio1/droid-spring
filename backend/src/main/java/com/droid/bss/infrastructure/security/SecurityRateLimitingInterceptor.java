 ...
 */
@Component
public class SecurityRateLimitingInterceptor implements HandlerInterceptor {

    private static final Logger log = LoggerFactory.getLogger(SecurityRateLimitingInterceptor.class);

    private final SecurityRateLimitingService rateLimitingService;

    public SecurityRateLimitingInterceptor(SecurityRateLimitingService rateLimitingService) {
