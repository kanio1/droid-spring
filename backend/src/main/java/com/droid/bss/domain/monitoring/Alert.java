...
/**
 * Domain entity representing an alert
 */
public class Alert {
    ...
    private String thresholdType; // WARNING, CRITICAL
    ...
    public Alert(Long customerId, Long resourceId, String metricType, String severity,
