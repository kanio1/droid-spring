...
/**
 * Contract tests for Subscription API using Pact
...
public class SubscriptionContractTest {
    ...
    void subscriptionExists() {
        // Setup state for subscription exists
    }

    @State("subscriptions exist")
    @IgnoreMissingStateChangeMethod
    void subscriptionsExist() {
        // Setup state for subscriptions list
    }

    @State("subscription created")
    @IgnoreMissingStateChangeMethod
    void subscriptionCreated() {
        // Setup state for subscription creation
    }
}
